...
interface NettyChannelHandlerFactory {
   ...
   */
  SimpleChannelUpstreamHandler createUpstreamHandler(String tag, ChannelGroup group, NettyEventListener listener);
}
...
class NettyDefaultChannelHandlerFactory implements NettyChannelHandlerFactory {
   ...
   */
  @Override
  public SimpleChannelUpstreamHandler createUpstreamHandler(String tag, ChannelGroup group, NettyEventListener listener) {
