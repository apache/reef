...
public final class MergingEventHandler<L,R> {
  ...
  public class Left implements EventHandler<L> {
    ...
    public void onNext(final L event) {
      ...
      synchronized(mutex) {
        ...
        if (LOG.isLoggable(Level.FINEST)) LOG.log(Level.FINEST, "{0} producing left {1}", new Object[] {Thread.currentThread(), event});
  ...
  public class Right implements EventHandler<R> {
    ...
    public void onNext(final R event) {
      ...
      synchronized(mutex) {
        ...
        if (LOG.isLoggable(Level.FINEST)) LOG.log(Level.FINEST, "{0} producing right {1}", new Object[] {Thread.currentThread(), event});
