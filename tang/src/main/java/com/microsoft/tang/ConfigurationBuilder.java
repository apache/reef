...
public interface ConfigurationBuilder {
     ...
     */
    <T> void bind(String iface, String impl) throws ClassNotFoundException;

    /**
     * Bind named parameters, implementations or external constructors,
     * depending on the types of the classes passed in.
     *
     * @param iface
     * @param impl
     */
    <T> void bind(Class<T> iface, Class<?> impl);
     ...
     */
    // TODO: This should not be here, but in Injector
    <T> void bindSingletonImplementation(Class<T> iface, Class<? extends T> impl) throws ReflectiveOperationException;
     ...
     * @throws BindException
     */
    <T> void bindSingleton(Class<T> iface) throws ReflectiveOperationException;
     ...
     * know how to parse the parameter's type.
     ...
     * @param cb
     */
    void addCommandLineOption(Option option, CommandLineCallback cb);
     ...
     */
    <T> void processCommandLine(String[] args)
