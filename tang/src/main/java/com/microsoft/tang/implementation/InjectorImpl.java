...
public class InjectorImpl implements Injector {
    ...
    /**
     * Return an injection plan for the given class / parameter name. This will
     * be more useful once plans can be serialized / deserialized / pretty
     * printed.
     *
     * @param name The name of an injectable class or interface, or a
     * NamedParameter.
     * @return
     * @throws NameResolutionException
     */
    ...
    /**
     * Returns true if ConfigurationBuilderImpl is ready to instantiate the
    ...
    public <U> U getInstance(Class<U> clazz) throws InjectionException {
        ...
        } catch (InjectionException | NameResolutionException | ReflectiveOperationException ex) {
