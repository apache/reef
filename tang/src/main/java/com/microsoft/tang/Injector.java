...
public interface Injector {
    ...
    /**
     * Gets an instance of iface, or the implementation that has been bound to
     * it. Unless iface (or its implementation) has been registered as a
     * singleton (by ConfigurationBuilder.bindSingleton()) this method will
     ...
     * @throws NameResolutionException
     */
    public abstract <T> void bindVolatialeInstance(Class<T> iface, T inst) throws BindException;
}