 ...
 * 
 */
public class BindNSToActivity implements EventHandler<ActivityStart>{
  ...
  @Override
  public void onNext(ActivityStart activity) {
    ns.registerId(idFac.getNewInstance(activity.getId()));
  }
