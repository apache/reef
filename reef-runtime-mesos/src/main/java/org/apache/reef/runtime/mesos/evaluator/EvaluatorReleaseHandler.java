...
/**
 * Handles evaluator release requests via MesosRemoteManager from MesosResourceReleaseHandler
 */
@EvaluatorSide
@Private
final class EvaluatorReleaseHandler implements EventHandler<RemoteMessage<EvaluatorReleaseProto>> {
  ...
  @Override
  public void onNext(final RemoteMessage<EvaluatorReleaseProto> remoteMessage) {
    this.mesosExecutor.get().onEvaluatorRelease();
  }
}
