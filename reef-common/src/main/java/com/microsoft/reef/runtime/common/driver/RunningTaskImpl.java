 ...
 */
final class RunningTaskImpl implements RunningTask {
  ...
  RunningTaskImpl(final EvaluatorManager evaluatorManager, final String taskId, final EvaluatorContext evaluatorContext) {
  ...
  public String toString() {
    return "TaskRuntime{taskId='" + taskId + "'}";
  }
}
