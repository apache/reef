...
public class ContextConfiguration extends ConfigurationModuleBuilder {
   ...
   */
  public static final OptionalImpl<ContextMessageHandler> ON_CONTEXT_RECEIVE_MESSAGE = new OptionalImpl<>();
  ...
  public static final ConfigurationModule CONF = new ContextConfiguration()
      ...
      .bindSetEntry(ContextConfigurationOptions.ContextMessageHandlers.class, ON_CONTEXT_RECEIVE_MESSAGE)
