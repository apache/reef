...
public class ActivityConfigurationRoundTripTest {
    ...
    public final class DummyActivity implements Activity {
        @Override
    ...
    private static Configuration configureMasterActivity(int d, double eps) throws BindException {
        final JavaConfigurationBuilder b = Tang.Factory.getTang().newConfigurationBuilder();
        b.bindImplementation(Activity.class, DummyActivity.class);
    ...
    public void testRoundTrip() throws BindException, InjectionException {
        ...
        final Configuration conf = configureMasterActivity(d, eps);
        {
