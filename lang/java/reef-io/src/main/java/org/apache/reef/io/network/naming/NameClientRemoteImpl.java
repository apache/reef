 ...
 */
public class NameClientRemoteImpl implements NameClient {
  private static final Logger LOG = Logger.getLogger(NameClientRemoteImpl.class.getName());
   ...
   * @param cache      a cache
   */
  public NameClientRemoteImpl(final String serverAddr,
   ...
   */
  @Inject
  public NameClientRemoteImpl(
      final @Parameter(NameClientParameters.NameServerAddr.class) String serverAddr,
      final @Parameter(NameClientParameters.NameServerPort.class) int serverPort,
    ...
    this(serverAddr, serverPort, timeout, factory, retryCount,
        retryTimeout, new NameCache(timeout), localAddressProvider, tpFactory);
  }
