...
public final class NameClientConfiguration extends ConfigurationModuleBuilder {
  ...
  public static final ConfigurationModule CONF = new NameClientConfiguration()
      .bindNamedParameter(NameClientParameters.NameServerPort.class, NAME_SERVICE_PORT)
      .bindNamedParameter(NameClientParameters.NameServerAddr.class, NAME_SERVER_HOSTNAME)
      .build();
}
