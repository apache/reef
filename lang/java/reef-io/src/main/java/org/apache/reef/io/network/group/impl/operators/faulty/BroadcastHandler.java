...
public class BroadcastHandler implements EventHandler<Message<ReefNetworkGroupCommProtos.GroupCommMessage>> {
  ...
  public void onNext(final Message<ReefNetworkGroupCommProtos.GroupCommMessage> value) {
    ...
    final ReefNetworkGroupCommProtos.GroupCommMessage oneVal = value.getData().iterator().next();
  ...
  public <T> T get(final Identifier id,
    ...
    final ReefNetworkGroupCommProtos.GroupCommMessage gcm = this.id2dataQue.get(id).take();
