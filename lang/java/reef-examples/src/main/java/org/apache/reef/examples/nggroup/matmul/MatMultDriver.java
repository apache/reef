...
import org.apache.reef.examples.utils.wake.BlockingEventHandler;
...
public final class MatMultDriver {
   ...
   */
  private static final Logger LOG = Logger.getLogger(MatMultDriver.class.getName());
  ...
  final class CompletedTaskHandler implements EventHandler<CompletedTask> {
    ...
    public final void onNext(final CompletedTask completed) {
      ...
      if (taskSubmitter.controllerCompleted(completed.getId())) {
        ...
        LOG.log(Level.INFO, "OUT: RESULT = {0}", new String(completed.get()));
      }
