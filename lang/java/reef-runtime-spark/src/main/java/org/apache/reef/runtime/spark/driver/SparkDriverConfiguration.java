 ...
 */
public final class SparkDriverConfiguration extends ConfigurationModuleBuilder {
  /**
   * @see JobIdentifier
   */
  ...
  public static final ConfigurationModule CONF = new SparkDriverConfiguration()
      .bindImplementation(ResourceLaunchHandler.class, SparkResourceLaunchHandler.class)
      .bindImplementation(ResourceReleaseHandler.class, SparkResourceReleaseHandler.class)
      .bindImplementation(ResourceRequestHandler.class, SparkResourceRequestHandler.class)
      .bindImplementation(ResourceManagerStartHandler.class, SparkRuntimeStartHandler.class)
      .bindImplementation(ResourceManagerStopHandler.class, SparkRuntimeStopHandler.class)
      .bindImplementation(TempFileCreator.class, WorkingDirectoryTempFileCreator.class)

      .bindNamedParameter(SparkMasterIp.class, SPARK_MASTER_IP)
      .bindNamedParameter(SparkSlavePort.class, SPARK_SLAVE_PORT)
      ...
      .bindNamedParameter(StageConfiguration.StageHandler.class, SparkSchedulerDriverExecutor.class)
