 ...
 */
public class SparkRemoteManagerCodec implements Codec<EvaluatorControl> {
  private static final Logger LOG = Logger.getLogger(SparkRemoteManagerCodec.class.getName());

  @Inject
  public SparkRemoteManagerCodec() {
  }
