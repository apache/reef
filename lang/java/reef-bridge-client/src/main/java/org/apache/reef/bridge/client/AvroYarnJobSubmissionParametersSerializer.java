...
final class AvroYarnJobSubmissionParametersSerializer {
   ...
   * @throws IOException
   */
  static AvroYarnJobSubmissionParameters fromFile(final File file)
          throws IOException {
   ...
   * @throws IOException
   */
  static AvroYarnJobSubmissionParameters fromInputStream(final InputStream inputStream) throws IOException {
