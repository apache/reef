...
namespace Org.Apache.REEF.Network.Examples.Elastic
{
    ...
    /// </summary>
    public sealed class ElasticBroadcastDriverWithFailureAfterBroadcast : ElasticBroadcastDriverWithFailures
    {
        [Inject]
        private ElasticBroadcastDriverWithFailureAfterBroadcast(
            ...
            get
            {
                return (taskId) => TangFactory.GetTang().NewConfigurationBuilder(
                    Context.GetTaskConfigurationModule(taskId)
                        .Set(TaskConfiguration.Task, GenericType<BroadcastSlaveTaskDieAfterBroadcast>.Class)
                        .Build())
                    .Build();
            }
        }
