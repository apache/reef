...
namespace Org.Apache.REEF.Common.Tests.Metrics
{
    ...
    {
        /// <summary>
        /// Tests normal functioning of Sink Handler. Metrics are pushed to the 
        /// handler, which puts them in the sink. It is then verified that sink 
        /// received all the metrics.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests SinkHandler restart functioning. Sink handler is stopped 
        /// and then re-started for each snapshot request.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests whether exception is thrown if we try to restart already 
        ...
        /// <summary>
        /// Tests whether exception is thrown if we try to stop already 
        ...
        /// <summary>
        /// Tests shut down function of Sink Handler. Checks that 
        /// shut down flag in sink handler is set properly.
        /// </summary>
        [Fact]
