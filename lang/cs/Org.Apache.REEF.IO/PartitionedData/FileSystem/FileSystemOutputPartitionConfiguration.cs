...
namespace Org.Apache.REEF.IO.PartitionedData.FileSystem
{
    ...
    public sealed class FileSystemOutputPartitionConfiguration<T> : ConfigurationModuleBuilder
    {
        /// <summary>
        ...
        /// It also set required parameters for injecting FileSystemDataSet
        /// </summary>
        public static ConfigurationModule ConfigurationModule = new FileSystemOutputPartitionConfiguration<T>()
            .BindImplementation(GenericType<IPartitionedOutputDataSet>.Class, GenericType<FileSystemPartitionOutputDataSet<T>>.Class)
            .BindSetEntry(GenericType<FilePathsForOutputPartitions>.Class, FilePathForPartitions)
