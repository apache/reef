...
{
    /// <summary>
    /// Driver-Side representation of a partitioned output data set.
    /// </summary>
    public interface IPartitionedOutputDataSet : IEnumerable<IPartitionDescriptor>
    {
        /// <summary>
