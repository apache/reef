...
{
    /// <summary>
    /// Message sent between NetworkServices. This will eventually replace NsMessage<T>
    /// after design is finalized</summary>
    /// <typeparam name="T">The type of data being sent</typeparam>
    [DataContract]
    public class StreamingNsMessage<T>
    {
        /// <summary>
        ...
        public StreamingNsMessage(IIdentifier sourceId, IIdentifier destId)
        {
            SourceId = sourceId;
            DestId = destId;
            Data = new List<T>();
        ...
        public StreamingNsMessage(IIdentifier sourceId, IIdentifier destId, T message) 
        {
            SourceId = sourceId;
            DestId = destId;
