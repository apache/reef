...
namespace Org.Apache.REEF.Network.Group.Task.Impl
{
    ...
    public class WritableCommunicationGroupNetworkObserver : IWritableCommunicationGroupNetworkObserver
    {
        private static readonly Logger LOGGER = Logger.GetLogger(typeof(WritableCommunicationGroupNetworkObserver));
        private readonly Dictionary<string, IObserver<WritableGeneralGroupCommunicationMessage>> _handlers;
        ...
        public void Register(string operatorName, IObserver<WritableGeneralGroupCommunicationMessage> observer)
        {
        ...
        /// <summary>
        /// Handles the incoming WritableGeneralGroupCommunicationMessage sent to this Communication Group.
        /// Looks for the operator that the message is being sent to and invoke its handler.
        /// </summary>
        /// <param name="message">The incoming message</param>
        public void OnNext(WritableGeneralGroupCommunicationMessage message)
        {
            string operatorName = message.OperatorName;

            IObserver<WritableGeneralGroupCommunicationMessage> handler = GetOperatorHandler(operatorName);
            if (handler == null)
            {
        ...
        /// <returns></returns>
        private IObserver<WritableGeneralGroupCommunicationMessage> GetOperatorHandler(string operatorName)
        {
            IObserver<WritableGeneralGroupCommunicationMessage> handler;
