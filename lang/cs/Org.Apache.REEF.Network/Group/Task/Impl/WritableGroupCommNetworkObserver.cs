...
namespace Org.Apache.REEF.Network.Group.Task.Impl
{
    ...
    public class WritableGroupCommNetworkObserver : IWritableGroupCommNetworkObserver
    {
        private static readonly Logger LOGGER = Logger.GetLogger(typeof(WritableGroupCommNetworkObserver));

        private readonly Dictionary<string, IObserver<WritableGeneralGroupCommunicationMessage>> _commGroupHandlers;
            
        /// <summary>
        /// Creates a new GroupCommNetworkObserver.
        /// </summary>
        [Inject]
        public WritableGroupCommNetworkObserver()
        {
            _commGroupHandlers = new Dictionary<string, IObserver<WritableGeneralGroupCommunicationMessage>>();
        }

        /// <summary>
        /// Handles the incoming WritableNsMessage for this Task.
        /// Delegates the WritableGeneralGroupCommunicationMessage to the correct 
        /// WritableCommunicationGroupNetworkObserver.
        /// </summary>
        /// <param name="nsMessage"></param>
        public void OnNext(WritableNsMessage<WritableGeneralGroupCommunicationMessage> nsMessage)
        {
            if (nsMessage == null)
            {
            ...
            try
            {
                WritableGeneralGroupCommunicationMessage gcm = nsMessage.Data.First();
        ...
        public void Register(string groupName, IObserver<WritableGeneralGroupCommunicationMessage> commGroupHandler)
        {
