...
namespace Org.Apache.REEF.Network.Group.Operators.Impl
{
    ...
    public class WritableReduceSender<T> : IReduceSender<T>
    {
        private static readonly Logger Logger = Logger.GetLogger(typeof (WritableReduceSender<T>));
