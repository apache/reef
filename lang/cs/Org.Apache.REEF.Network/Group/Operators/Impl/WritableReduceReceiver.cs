...
namespace Org.Apache.REEF.Network.Group.Operators.Impl
{
    ...
    public class WritableReduceReceiver<T> : IReduceReceiver<T>
    {
        private static readonly Logger Logger = Logger.GetLogger(typeof (WritableReduceReceiver<T>));
        ...
        [Inject]
        private WritableReduceReceiver(
