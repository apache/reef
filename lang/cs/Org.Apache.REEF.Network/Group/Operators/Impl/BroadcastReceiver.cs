...
namespace Org.Apache.REEF.Network.Group.Operators.Impl
{
    ...
    {
        protected readonly ICommunicationGroupNetworkObserver _networkHandler;
        protected readonly OperatorTopology<PipelineMessage<T>> _topology;
        ...
        public T Receive()
        {
            ...
            //LOGGER.Log(Level.Info, "starting receiving pipelined message");
            do
            {
            ...
            //LOGGER.Log(Level.Info, "ending receiving pipelined message");
