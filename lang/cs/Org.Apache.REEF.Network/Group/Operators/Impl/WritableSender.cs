...
namespace Org.Apache.REEF.Network.Group.Operators.Impl
{
    ...
    public class WritableSender
    {
        private readonly INetworkService<WritableGeneralGroupCommunicationMessage> _networkService;
        ...
        public void Send(WritableGeneralGroupCommunicationMessage message)
        {
            if (message == null)
            {
