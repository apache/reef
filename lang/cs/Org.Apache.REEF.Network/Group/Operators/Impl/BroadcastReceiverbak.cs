...
namespace Org.Apache.REEF.Network.Group.Operators.Impl
{
    ...
    {
        private static readonly Logger LOGGER = Logger.GetLogger(typeof(PipelinedBroadcastSender<T>));
        ...
        public T Receive()
        {
            LOGGER.Log(Level.Info, "*****************in boradcast receiving message from parent*************8");

            var data = _topology.ReceiveFromParent();

            LOGGER.Log(Level.Info, "********************in boradcast sending message to chldren************************8");
            ...
            LOGGER.Log(Level.Info, "****************888in boradcast done sending message to chldren***************");
