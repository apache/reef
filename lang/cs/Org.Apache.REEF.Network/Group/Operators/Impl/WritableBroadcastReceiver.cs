...
namespace Org.Apache.REEF.Network.Group.Operators.Impl
{
    ...
    public class WritableBroadcastReceiver<T> : IBroadcastReceiver<T>
    {
        private const int PipelineVersion = 3;
        private readonly WritableOperatorTopology<PipelineMessage<T>> _topology;
        private static readonly Logger Logger = Logger.GetLogger(typeof(WritableBroadcastReceiver<T>));
        /// <summary>
