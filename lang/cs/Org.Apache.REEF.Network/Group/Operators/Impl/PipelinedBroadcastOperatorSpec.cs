...
{
    /// <summary>
    /// The specification used to define Pipelined Broadcast Operators.
    /// </summary>
    public class PipelinedBroadcastOperatorSpec<T> : BroadcastOperatorSpec<T>
    {
        /// <summary>
        ...
        public PipelinedBroadcastOperatorSpec(
            string senderId, 
            ICodec<T> codecType, 
            IPipelineDataConverter<T> dataConverter)
            : base(senderId, codecType)
        {
