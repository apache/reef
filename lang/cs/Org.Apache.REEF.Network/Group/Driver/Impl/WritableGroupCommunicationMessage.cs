...
namespace Org.Apache.REEF.Network.Group.Driver.Impl
{
    ...
    public class WritableGroupCommunicationMessage<T> : WritableGeneralGroupCommunicationMessage
    {
        ...
        /// </summary>
        [Inject]
        public WritableGroupCommunicationMessage(IStreamingCodec<T> codec)
        {
            _codec = codec;
        }
        ...
        public WritableGroupCommunicationMessage(
            string groupName,
            string operatorName,
            string source,
            string destination,
