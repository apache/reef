...
namespace Org.Apache.REEF.Network.Group.Driver.Impl
{
    ...
    public class WritableGroupCommDriver : IWritableGroupCommDriver
    {
        ...
        public IConfiguration GetServiceConfiguration()
        {
            IConfiguration serviceConfig = ServiceConfiguration.ConfigurationModule
                .Set(ServiceConfiguration.Services, GenericType<WritableNetworkService<WritableGeneralGroupCommunicationMessage>>.Class)
                .Build();
