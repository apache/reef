...
{
    /// <summary>
    /// Codec for the float array
    /// </summary>
    public class FloatArrayCodec : ICodec<float[]>
    {
        [Inject]
        ...
        public float[] Decode(byte[] data)
        {
            ...
            {
                throw new Exception("error inside float array decoder, byte array length not a multiple of interger size");
            }
