...
{
    /// <summary>
    /// Used to create Min Reduce function on int to be used by Reduce operator
    /// </summary>
    public class IntegerMinFunction : IReduceFunction<int>
    {
        [Inject]
        public IntegerMinFunction()
        {
        }

        /// <summary>
        /// The min function over integers
        /// </summary>
