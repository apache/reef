...
{
    /// <summary>
    /// Used to create Max Reduce function on int to be used by Reduce operator
    /// </summary>
    public class IntegerMaxFunction : IReduceFunction<int>
    {
        [Inject]
        public IntegerMaxFunction()
        {
        }

        /// <summary>
        /// The max function over integers
        /// </summary>
