...
{
    /// <summary>
    /// Test class for unit testing the AzureBlobFileSystem.
    /// Some methods are currently not unit tested due to the complexity of "faking out"
    /// the methods. They are instead tested E2E in TestAzureBlobFileSystemE2E
    /// </summary>
    [TestClass]
    public sealed class TestAzureBlobFileSystem
    {
        ...
        public void TestDelete()
        {
            ...
            testContext.TestCloudBlob.Received(1).Delete();
        }

        [TestMethod, ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void TestDeleteAtContainer()
        {
            new TestContext().GetAzureFileSystem().Delete(new Uri(FakeUri, "container"));
        }
        ...
        public void TestExists()
        {
            ...
            testContext.TestCloudBlob.Received(1).Exists();
        }
        ...
        public void TestCopyToLocal()
        {
            ...
            testContext.TestCloudBlob.Received(1).DownloadToFile("local", FileMode.CreateNew);
        }
        ...
        private sealed class TestContext
        {
            ...
            public IFileSystem GetAzureFileSystem()
            {
                ...
                TestCloudBlobClient.GetBlobReferenceFromServer(FakeUri).ReturnsForAnyArgs(TestCloudBlob);
                ...
                return injector.GetInstance<AzureBlobFileSystem>();
            }
        }
    }
}
