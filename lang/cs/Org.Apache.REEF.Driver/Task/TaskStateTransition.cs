...
namespace Org.Apache.REEF.Driver.Task
{
    ...
    {
        private readonly TaskStates _currentState;
        private readonly TaskEvents _taskEvent;

        public TaskStateTransition(TaskStates currentState, TaskEvents taskEvent)
        {
