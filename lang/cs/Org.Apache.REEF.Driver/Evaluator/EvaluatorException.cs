...
namespace Org.Apache.REEF.Driver.Evaluator
{
    ...
    public sealed class EvaluatorException : Exception, IIdentifiable
    {
        ...
        internal EvaluatorException(string evaluatorId)
        {
            _evaluatorId = evaluatorId;
            _runningTask = null;
        }

        internal EvaluatorException(string evaluatorId, string message, Exception cause)
            : base(message, cause)
        {
            _evaluatorId = evaluatorId;
            _runningTask = null;
        ...
        internal EvaluatorException(string evaluatorId, string message, IRunningTask runningTask)
            : base(message)
        {
            _evaluatorId = evaluatorId;
        ...
        internal EvaluatorException(string evaluatorId, Exception cause, IRunningTask runningTask)
