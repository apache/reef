...
{
    public sealed class NameResolutionException : BindException
    {
        internal NameResolutionException(string name, string longestPrefix) :
        ...
        internal NameResolutionException(string message, Exception innerException)
