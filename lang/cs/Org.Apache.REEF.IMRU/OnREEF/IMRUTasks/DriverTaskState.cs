...
namespace Org.Apache.REEF.IMRU.OnREEF.IMRUTasks
{
    ...
    internal sealed class DriverTaskState
    {
            ...
            new Dictionary<TaskStateTransition, TaskState>
        {
            ...
            { new TaskStateTransition(TaskState.TaskSubmitted, TaskEvent.FailedTaskAppError), TaskState.TaskFailedByAppError },
            { new TaskStateTransition(TaskState.TaskSubmitted, TaskEvent.FailedTaskSystemError), TaskState.TaskFailedBySystemError },
            ...
            { new TaskStateTransition(TaskState.TaskRunning, TaskEvent.FailedTaskAppError), TaskState.TaskFailedByAppError },
            { new TaskStateTransition(TaskState.TaskRunning, TaskEvent.FailedTaskSystemError), TaskState.TaskFailedBySystemError },
            ...
            { new TaskStateTransition(TaskState.TaskFailedBySystemError, TaskEvent.FailedTaskEvaluatorError), TaskState.TaskFailedByEvaluatorFailure },
