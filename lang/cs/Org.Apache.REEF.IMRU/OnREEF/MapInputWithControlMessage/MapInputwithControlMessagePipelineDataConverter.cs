...
namespace Org.Apache.REEF.IMRU.OnREEF.MapInputWithControlMessage
{
    ...
    internal class MapInputwithControlMessagePipelineDataConverter<TMapInput> : IPipelineDataConverter<MapInputWithControlMessage<TMapInput>>
    {
        private readonly IPipelineDataConverter<TMapInput> _basePipelineDataConverter;

        [Inject]
        internal MapInputwithControlMessagePipelineDataConverter(IPipelineDataConverter<TMapInput> basePipelineDataConverter)
        {
        ...
        public List<PipelineMessage<MapInputWithControlMessage<TMapInput>>> PipelineMessage(MapInputWithControlMessage<TMapInput> message)
        {
        ...
        public MapInputWithControlMessage<TMapInput> FullMessage(List<PipelineMessage<MapInputWithControlMessage<TMapInput>>> pipelineMessage)
        {
