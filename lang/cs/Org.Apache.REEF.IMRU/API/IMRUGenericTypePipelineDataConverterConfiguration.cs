...
namespace Org.Apache.REEF.IMRU.API
{
    ...
    public sealed class IMRUGenericTypePipelineDataConverterConfiguration<T> : ConfigurationModuleBuilder
    {
        /// <summary>
        ...
        public static ConfigurationModule ConfigurationModule =
            new IMRUGenericTypePipelineDataConverterConfiguration<T>()
