...
/**
 * A ConfigurationModule for the TestActivity.
 */
public final class TestActivityConfiguration extends ConfigurationModuleBuilder {
  /**
  ...
  public static final ConfigurationModule CONF = new TestActivityConfiguration()
