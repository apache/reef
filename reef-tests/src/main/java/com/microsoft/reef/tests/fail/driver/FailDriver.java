...
public final class FailDriver {
  ...
  final class FailedContextHandler implements EventHandler<FailedContext> {
    ...
    public void onNext(final FailedContext context) {
      LOG.log(Level.WARNING, "Context failed: " + context.getId(), context.getCause().orElse(null));
      checkMsgOrder(context);
      // TODO: notify client?
  ...
  final class FailedActivityHandler implements EventHandler<FailedActivity> {
    ...
    public void onNext(final FailedActivity act) {
      LOG.log(Level.WARNING, "Activity failed: " + act.getId(), act.getCause().orElse(null));
      checkMsgOrder(act);
