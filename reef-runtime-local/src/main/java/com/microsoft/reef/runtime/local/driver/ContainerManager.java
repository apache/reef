...
final class ContainerManager implements AutoCloseable {
  ...
  final Container allocateOne(final int megaBytes, final int core) {
    synchronized (this.containers) {
      ...
      final ProcessContainer container = new ProcessContainer(
          this.errorHandlerRID, nodeId, processID, processFolder, megaBytes, core, this.fileNames, this.processObserver);
