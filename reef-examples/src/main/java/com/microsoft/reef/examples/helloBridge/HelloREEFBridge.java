 ...
 */
public final class HelloREEFBridge {

  private static final Logger LOG = Logger.getLogger(HelloREEFBridge.class.getName());
  ...
  public static LauncherStatus runHelloReef(final Configuration runtimeConf, final int timeOut)
    ...
    final Configuration driverConf =
        EnvironmentUtils.addClasspath(DriverConfiguration.CONF, DriverConfiguration.GLOBAL_LIBRARIES)
          ...
          .set(DriverConfiguration.ON_DRIVER_STARTED, HelloBridgeDriver.StartHandler.class)
          .set(DriverConfiguration.ON_EVALUATOR_ALLOCATED, HelloBridgeDriver.EvaluatorAllocatedHandler.class)
        .build();
