...
public final class HelloCLRBridge {
  ...
  public static LauncherStatus runHelloCLR(final Configuration runtimeConf, final int timeOut, final File clrFolder)
    ...
    ConfigurationModule driverConf = DriverConfiguration.CONF
        .set(DriverConfiguration.DRIVER_IDENTIFIER, "HelloCLRBridge")
        .set(DriverConfiguration.ON_DRIVER_STARTED, HelloCLRBridgeDriver.StartHandler.class)
        .set(DriverConfiguration.ON_EVALUATOR_ALLOCATED, HelloCLRBridgeDriver.EvaluatorAllocatedHandler.class);
