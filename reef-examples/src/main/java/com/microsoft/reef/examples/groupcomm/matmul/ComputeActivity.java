...
/**
 * ComputeActivity Receives the partial matrix(row partitioned) it is
 ...
 * 
 */
public class ComputeActivity implements Activity {
  private final Logger logger = Logger.getLogger(ComputeActivity.class
      .getName());
	/**
	 ...
	 * are complementary to the ones used in the ControllerActivity
	 */
	 ...
	 */
	@Inject
	public ComputeActivity(Scatter.Receiver<Vector> scatterReceiver,
			Broadcast.Receiver<Vector> broadcastReceiver,
			Reduce.Sender<Vector> reduceSender) {
		super();
